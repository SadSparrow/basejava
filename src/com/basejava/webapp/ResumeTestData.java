...
public class ResumeTestData {
    ...
    public static Resume createResume(String uuid, String fullname) {
        ...
        organizations.add(new Organization("Java Online Projects", "https://javaops.ru/", LocalDate.ofYearDay(2013, 10), "Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок."));
